				...
				<div class="body">
					<form action="<?php base_url('indirect/historiorder/add') ?>" id="form_advanced_validation" method="post" enctype="multipart/form-data" autocomplete="on">
						...
						<!-- <div class="form-group form-float">
							<div class="form-line"> -->
								<input type="hidden" name="id_histori_order" class="form-control" value="<?php echo $histori->id_histori_order ?>"/>
						...
						<div class="form-group form-float">
							<div class="form-line" id="bs_datepicker_container">
								<input class="form-control <?php echo form_error('tanggal') ? 'is-invalid':'' ?>" type="text" name="tanggal" value="<?php echo $histori->tanggal ?>"/>
						...
						<div class="form-group form-float">
							...
							name="kode_marketing" data-live-search="true">
								...
								<?php foreach($marketing as $can) : ?>
									<option value="<?php echo $can->kode_marketing ?>" <?php echo $can->kode_marketing == $histori->kode_marketing ? "selected" : "" ?>><?php echo $can->nama_marketing ?></option>
								<?php endforeach; ?>
							</select>
						</div>
						...
						<div class="form-group form-float">
							...
							name="id_outlet" data-live-search="true">
								...
								<?php foreach($outlet as $can) : ?>
									<option value="<?php echo $can->id_outlet ?>" <?php echo $can->id_outlet == $histori->id_outlet ? "selected" : "" ?>><?php echo $can->nama_outlet ?></option>
								<?php endforeach; ?>
							</select>
						</div>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('as') ? 'is-invalid':'' ?>"
								type="text" name="as" onkeypress="return isNumberKey(event)" value="<?php echo $histori->as ?>"/>
						...
						<div class="form-group form-float">						
							...
							<input class="form-control <?php echo form_error('simpati') ? 'is-invalid':'' ?>"
								type="text" name="simpati"  onkeypress="return isNumberKey(event)" value="<?php echo $histori->simpati ?>"/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('loop') ? 'is-invalid':'' ?>"
								type="text" name="loop" onkeypress="return isNumberKey(event)" value="<?php echo $histori->loop ?>"/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('nsb') ? 'is-invalid':'' ?>"
								type="text" name="nsb" onkeypress="return isNumberKey(event)" value="<?php echo $histori->nsb ?>"/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('mkios_reguler') ? 'is-invalid':'' ?>"
								type="text" name="mkios_reguler" onkeypress="return isNumberKey(event)" value="<?php echo $histori->mkios_reguler ?>"/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('mkios_bulk') ? 'is-invalid':'' ?>"
								type="text" name="mkios_bulk" onkeypress="return isNumberKey(event)" value="<?php echo $histori->mkios_bulk ?>"/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('gt_pulsa') ? 'is-invalid':'' ?>"
								type="text" name="gt_pulsa" onkeypress="return isNumberKey(event)" value="<?php echo $histori->gt_pulsa ?>"/>
