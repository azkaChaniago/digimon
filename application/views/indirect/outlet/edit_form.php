	...
	<section class="content">
		...
		<?php endif; ?>
			...
			<div class="card">
				...
				<div class="body">
					<form action="<?php base_url('indirect/outlet/edit') ?>" id="form_advanced_validation" method="post" enctype="multipart/form-data" autocomplete="on" enctype="multipart/form-data">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							...
							<input type="hidden" value="<?php echo htmlspecialchars($outlet->galeri_foto, ENT_QUOTES, 
							'UTF-8') ?>" name="galeri_lama" />
