            ...
            <div class="container">
                <div class="card">
                    <div class="header">   
                        ...
                        <a href="<?php echo site_url('indirect/outlet') ?>" class="btn btn-danger waves-effect"><i class="material-icons">arrow_back</i>
                        <span>Kembali<span></a>
                    </div>
                    <div class="body">
                        <table class="table table-stripped">
                            ...
                            <tr>
                                <th colspan="5">
                                    <?php 
                                    $i = 0;
                                    // echo $outlet->galeri_foto;
                                    if ($outlet->galeri_foto != null) :
                                        ...
                                        <div class="col-md-3">
                                            <img src="<?php echo base_url('upload/default.png') ?>" class="img img-responsive" />
                                        </div>                                    
                                    <?php endif;?>
                                </th>
                            </tr>
