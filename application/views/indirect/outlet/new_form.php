...
<body class="theme-red">
	...
	<section class="content">
		...
		<?php endif; ?>
			...
			<div class="card">
				<div class="header">
					<h2><a href="<?php echo site_url('indirect/outlet') ?>" class="btn btn-danger waves-effect"><i class="material-icons">arrow_back</i>
					<span>Kembali<span></a></h2>
				</div>
				<div class="body">
					<form action="<?php base_url('indirect/outlet/add') ?>" id="form_advanced_validation" method="post" enctype="multipart/form-data" autocomplete="on" enctype="multipart/form-data">
						<div class="col-md-6">
							<div class="form-group form-float">
								<div class="form-line">
								<input class="form-control" type="text" name="id_outlet" required/>
							...
							<div class="form-group form-float">
								<div class="form-line">
								<input class="form-control"	type="text" name="nama_pemilik" required/>
						...
						<div class="col-md-6">
							...
							<div class="form-group form-float">
								<div class="form-line">
								<input class="form-control" type="text" name="hari_kunjungan" required/>
							...
							<div class="form-group form-float">
								<div class="form-line">
								<input class="form-control" type="text" name="nomor_rs" required/>
							...
							<div class="form-group form-float">
								<div class="form-line">
								<input class="form-control"	type="text" name="kategori_outlet" required/>
