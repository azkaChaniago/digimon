	...
	<section class="content">
		<div class="container-fluid">
			...
			<div class="card">
				...
				<div class="body">
					<form action="<?php base_url('indirect/distribusi/add') ?>" id="form_advanced_validation" method="post" enctype="multipart/form-data" autocomplete="on">
						...
						<div class="form-group form-float">
							<div class="form-line">
							<input class="form-control <?php echo form_error('outlet_aktif digital') ? 'is-invalid':'' ?>"
								type="text" name="outlet_aktif digital" onkeypress="return isNumberKey(event)"required/>
								<label class="form-label" for="outlet_aktif digital">Outlet Aktif Digital*</label>
							</div>
						</div>
