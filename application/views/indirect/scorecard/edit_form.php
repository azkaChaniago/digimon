				...
				<div class="body">
					<form action="<?php base_url('indirect/scorecard/add') ?>" id="form_advanced_validation" method="post" enctype="multipart/form-data" autocomplete="on">
						...
						<!-- <div class="form-group form-float">
							<div class="form-line"> -->
								<input type="hidden" name="id_score_card" class="form-control" value="<?php echo $score->id_score_card ?>" required/>
								<!-- <label class="form-label" for="id_score_card">ID Score Card*</label> -->
							<!-- </div>
						</div> -->

						<div class="form-group form-float">
							<div class="form-line" id="bs_datepicker_container">
								<input class="form-control <?php echo form_error('tanggal') ? 'is-invalid':'' ?>" type="text" name="tanggal"  value="<?php echo $score->tanggal ?>" placeholder="Tanggal" required/>
						...
						<div class="form-group form-float">
							...
							name="kode_marketing" data-live-search="true">
								...
								<?php foreach($marketing as $can) : ?>
									<option value="<?php echo $can->kode_marketing ?>" <?php echo $can->kode_marketing == $score->kode_marketing ? "selected" : "" ?>><?php echo $can->nama_marketing ?></option>
								<?php endforeach; ?>
							</select>
						</div>
						...
						<div class="form-group form-float">						
							...
							<input class="form-control <?php echo form_error('new_opening_outlet') ? 'is-invalid':'' ?>"
								type="text" name="new_opening_outlet"  onkeypress="return isNumberKey(event)" value="<?php echo $score->new_opening_outlet ?>" required/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('outlet_aktif_digital') ? 'is-invalid':'' ?>"
								type="text" name="outlet_aktif_digital" onkeypress="return isNumberKey(event)" value="<?php echo $score->outlet_aktif_digital ?>" required/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('outlet_aktif_voucher') ? 'is-invalid':'' ?>"
								type="text" name="outlet_aktif_voucher" onkeypress="return isNumberKey(event)" value="<?php echo $score->outlet_aktif_voucher ?>" required/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('outlet_aktif_bang_tcash') ? 'is-invalid':'' ?>"
								type="text" name="outlet_aktif_bang_tcash" onkeypress="return isNumberKey(event)" value="<?php echo $score->outlet_aktif_bang_tcash ?>" required/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('sales_perdana') ? 'is-invalid':'' ?>"
								type="text" name="sales_perdana" onkeypress="return isNumberKey(event)" value="<?php echo $score->sales_perdana ?>" required/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('nsb') ? 'is-invalid':'' ?>"
								type="text" name="nsb" onkeypress="return isNumberKey(event)" value="<?php echo $score->nsb ?>" required/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('mkios_reguler') ? 'is-invalid':'' ?>"
								type="text" name="mkios_reguler" onkeypress="return isNumberKey(event)" value="<?php echo $score->mkios_reguler ?>" required/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('mkios_bulk') ? 'is-invalid':'' ?>"
								type="text" name="mkios_bulk" onkeypress="return isNumberKey(event)" value="<?php echo $score->mkios_bulk ?>" required/>
						...
						<div class="form-group form-float">
							...
							<input class="form-control <?php echo form_error('gt_pulsa') ? 'is-invalid':'' ?>"
								type="text" name="gt_pulsa" onkeypress="return isNumberKey(event)" value="<?php echo $score->gt_pulsa ?>" required/>
