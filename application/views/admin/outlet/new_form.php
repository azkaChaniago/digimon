	...
	<section class="content">
		...
		<?php endif; ?>
			...
			<div class="card">
				...
				<div class="body">
					<form action="<?php base_url('admin/outlet/add') ?>" id="form_advanced_validation" method="post" enctype="multipart/form-data" autocomplete="on" enctype="multipart/form-data">
						<div class="col-md-6">
