						...
						<form action="<?php base_url('admin/users/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('username') ? 'is-invalid':'' ?>"
								 type="text" name="username" placeholder="Username" value="<?php echo $users->user_name ?>" />
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('user_email') ? 'is-invalid':'' ?>"
								 type="email" name="email" placeholder="user@domain.com" value="<?php echo $users->user_email ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('password') ? 'is-invalid':'' ?>"
								 type="password" name="password" placeholder="Password" value="<?php echo $users->user_password ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('status') ? 'is-invalid':'' ?>"
								 type="status" name="status" placeholder="(e.g. superuser, assistant, student)" value="<?php echo $users->user_status ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input type="hidden" name="old_image" value="<?php echo $users->user_avatar ?>" />
								<div class="invalid-feedback">
