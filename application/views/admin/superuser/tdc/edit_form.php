			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/superuser/tdc/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('admin/superuser/tdc/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="row">
								<div class="offset-md-2 col-md-6">
									 <div class="form-group">
										<input class="form-control <?php echo form_error('kode_tdc') ? 'is-invalid':'' ?>"
										type="hidden" name="kode_tdc" placeholder="Kode User" value="<?php echo $tdc->kode_tdc ?>" />
									...
									<div class="form-group">
										...
										type="text" name="nama_tdc" placeholder="Nama TDC" value="<?php echo $tdc->nama_tdc ?>" />
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										type="text" name="no_telepon" placeholder="No Telepon" value="<?php echo $tdc->no_telepon ?>" />
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										type="text" name="no_callcenter" placeholder="No Callcenter" value="<?php echo $tdc->no_callcenter ?>" />
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										type="text" name="manager" placeholder="Nama Manajer" value="<?php echo $tdc->manager ?>" />
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										type="text" name="alamat" placeholder="Alamat" value="<?php echo $tdc->alamat ?>" />
										<div class="invalid-feedback">
