			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/superuser/marketing/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('admin/superuser/marketing/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="row">
							<div class="offset-md-2 col-md-6">
									...
									<div class="form-group">
										...
										name="kode_tdc">
											<?php foreach($tdc as $t) : ?>
												<option value="<?php echo $t->kode_tdc ?>" <?php if ($t->kode_tdc == $marketing->kode_tdc) { echo "selected"; } ?>><?php echo $t->nama_tdc ?></option>
											<?php endforeach; ?>
										</select>
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										name="divisi">
											<option value="direct" <?php if ($marketing->divisi == "direct") { echo "selected"; } ?>>Direct</option>
											<option value="indirect" <?php if ($marketing->divisi == "indirect") { echo "selected"; } ?>>Indirect</option>
										</select>
										<div class="invalid-feedback">
