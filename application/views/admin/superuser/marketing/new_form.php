							...
							<div class="row">
								<div class="offset-md-2 col-md-6">
									<div class="form-group">
										...
										type="text" name="kode_marketing" placeholder="Kode Marketing" />
									...
									<div class="form-group">
										...
										type="text" name="nama_marketing" placeholder="Nama Marketing" />
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										type="text" name="mkios" placeholder="MKIOS" />
										<div class="invalid-feedback">
