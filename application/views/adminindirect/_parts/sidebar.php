        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="<?php echo $this->uri->segment(2) == 'home' ? 'active': ''?>">
                    <a href="<?php echo site_url('adminindirect/home') ?>">
                        <i class="material-icons">show_chart</i>
                        <span>KPI</span>
                    </a>
                </li>
                <li class="<?php echo $this->uri->segment(2) == 'outlet' ? 'active': ''?>">
                    <a href="<?php echo site_url('adminindirect/outlet') ?>">
                ...
                <li class="<?php if($this->uri->segment(2) == 'distribusi' || $this->uri->segment(2) == 'distribusicollector') { echo 'active'; }?>">
                    ...
                    <ul class="ml-menu">
                        <li class="<?php echo $this->uri->segment(2) == 'distribusi' ? 'active': ''?>">
                            <a href="<?php echo site_url('adminindirect/distribusi') ?>">Canvasser</a>
                        </li>
                        <li class="<?php echo $this->uri->segment(2) == 'distribusicollector' ? 'active': ''?>">
                            <a href="<?php echo site_url('adminindirect/distribusicollector') ?>">Collector</a>
                        </li>
                    </ul>
                </li>
                <li class="<?php echo $this->uri->segment(2) == 'historiorder' ? 'active': ''?>">
                    <a href="<?php echo site_url('adminindirect/historiorder') ?>">
                ...
                <li class="<?php if($this->uri->segment(2) == 'scorecard' || $this->uri->segment(2) == 'scorecardcollector') { echo 'active'; }?>">
                    ...
                    <ul class="ml-menu">
                        <li class="<?php echo $this->uri->segment(2) == 'scorecard' ? 'active': ''?>">
                            <a href="<?php echo site_url('adminindirect/scorecard') ?>">Canvasser</a>
                        </li>
                        <li class="<?php echo $this->uri->segment(2) == 'scorecardcollector' ? 'active': ''?>">
                            <a href="<?php echo site_url('adminindirect/scorecardcollector') ?>">Collector</a>
                        </li>
                    </ul>
                </li>
                <li class="<?php if($this->uri->segment(2) == 'sharereguler' || $this->uri->segment(2) == 'sharebroadband' || $this->uri->segment(2) == 'marketchart') { echo 'active'; }?>">
                    ...
                    <ul class="ml-menu">
                        <li class="<?php echo $this->uri->segment(2) == 'marketchart' ? 'active': ''?>">
                            <a href="<?php echo site_url('adminindirect/marketchart') ?>">Marketshare Charts</a>
                        </li>
                        <li class="<?php echo $this->uri->segment(2) == 'sharereguler' ? 'active': ''?>">
                            <a href="javascript:void(0);" class="menu-toggle">Marketshare Reguler</a>
                            <ul class="ml-menu">
                                <li class="<?php echo $this->uri->segment(3) == 'marketshare' ? 'active': ''?>">
                                    <a href="<?php echo site_url('adminindirect/sharereguler/marketshare') ?>">Marketshare</a>
                                </li>
                                <li class="<?php echo $this->uri->segment(3) == 'rechargeshare' ? 'active': ''?>">
                                    <a href="<?php echo site_url('adminindirect/sharereguler/rechargeshare') ?>">Rechargeshare</a>
                                </li>
                                <li class="<?php echo $this->uri->segment(3) == 'salesshare' ? 'active': ''?>">
                                    <a href="<?php echo site_url('adminindirect/sharereguler/salesshare') ?>">Salesshare</a>
                                </li>
                            </ul>
                        </li>
                        <li class="<?php echo $this->uri->segment(2) == 'sharebroadband' ? 'active': ''?>">
                            <a href="<?php echo site_url('adminindirect/sharebroadband') ?>">Marketshare Broadband</a>
                        </li>
                    </ul>
                </li>
                <li class="<?php echo $this->uri->segment(2) == 'galeri' ? 'active': ''?>">
                    <a href="<?php echo site_url('adminindirect/galeri') ?>">
                        <i class="material-icons">photo_library</i>
                        <span>Galeri Foto</span>
                    </a>
                </li>       
                <li class="<?php echo $this->uri->segment(2) == 'laporan' ? 'active': ''?>">
                    <a href="<?php echo site_url('adminindirect/laporan') ?>">
