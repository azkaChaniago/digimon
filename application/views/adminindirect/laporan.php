...
<body class="theme-red">
		...
		<div class="container-fluid">
			...
			<div class="card">
				...
				<div class="body">
					...
					<div class="row">
						<form id="monthform" action="<?php echo site_url('adminindirect/laporan/exportpdf') ?>" method='post'>
							<div class="col-md-5">
	...
	<script>
		...
		// 	$('#result').dataTable({
		// 		"ajax": {
		// 			url: "<?php echo site_url('adminindirect/laporan/getreport') ?>",
		// 			type: 'GET'
		// 		}
		// 	})
		// })
		...
		// 		$.ajax({
		// 			url: '<?php echo site_url('adminindirect/laporan/getpivot') ?>',
		// 			type: 'POST',
		// 			async: true,
		// 			dataType: 'JSON',
