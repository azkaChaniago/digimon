...
<body class="theme-red">
	...
	<div class="container-fluid">
		<div class="card">
			<div class="header">
				<div class="row">
					<form action="<?php echo site_url('adminindirect/sharereguler/fetchrecharge') ?>" method="post">
						<div class="col-md-5">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					<div class="header">
						<div class="text-center"><h2>Rechargeshare Cluster Lampung</h2></div>
					</div>
					<div class="body">
							...
							<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo $reg->mount_simpati_rechargeshare ?></td>
										<td><?php echo $reg->mount_as_rechargeshare ?></td>
										<td><?php echo $reg->mount_loop_rechargeshare ?></td>
										<td><?php echo $reg->mount_mentari_rechargeshare ?></td>
										<td><?php echo $reg->mount_im3_rechargeshare ?></td>
										<td><?php echo $reg->mount_xl_rechargeshare ?></td>
										<td><?php echo $reg->mount_tri_rechargeshare ?></td>
										<td><?php echo $reg->mount_smartfrend_rechargeshare ?></td>
										<!-- <td width='180'>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					<div class="header">
						<div class="text-center"><h2>Detail Rechargeshare Cluster</h2></div>
					</div>
					<div class="body">
	...
	<script>
		...
		document.getElementById("kabupaten").onclick = function(evt){
            ...
            console.log(label);
            window.location.href = "<?php echo site_url('adminindirect/sharereguler/rechargeshare/') ?>" + label;
        };
