...
<body class="theme-red">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="card">
				<div class="header">
					<div class="row">
						<form action="<?php echo site_url('adminindirect/sharereguler/fetchsales') ?>" method="post">
							<div class="col-md-5">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					<div class="header">
						<div class="text-center"><h2>Salesshare Cluster Lampung</h2></div>
					</div>
					<div class="body">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					<div class="header">
						<div class="text-center"><h2>Detail Salesshare Cluster</h2></div>
					</div>
					<div class="body">
			...
			<div class="col-md-6">
				<div class="card">
					<div class="header">
						<div class="text-center"><h2>Detail Salesshare Kabupaten <?php echo str_replace("%20"," ", $this->uri->segment(4)) ?></h2></div>
					</div>
					<div class="body">
	...
	<script>
		...
		document.getElementById("kabupaten").onclick = function(evt){
            ...
            console.log(label);
            window.location.href = "<?php echo site_url('adminindirect/sharereguler/salesshare/') ?>" + label;
        };
