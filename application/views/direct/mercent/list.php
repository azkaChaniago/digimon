							...
							<tbody>
								...
								<tr>
									...
									<td width='180' class="text-center" >
										<a href="<?php echo site_url('direct/event/edit/'.$mer->id_mercent) ?>"><i class="material-icons">edit</i></a>
										<a onclick="deleteConfirm('<?php echo site_url('direct/deventdelete/'.$mer->id_mercent) ?>')" href="#!"><i class="material-icons">delete</i></a>
										<a href="<?php echo site_url('direct/event/detail/'.$mer->id_mercent) ?>"><i class="material-icons">description</i></a>	
									</td>
								</tr>
								<?php endforeach; ?>
