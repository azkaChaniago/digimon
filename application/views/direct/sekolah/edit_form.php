	...
	<section class="content">
		<div class="container-fluid">
			...
			<div class="card">
				...
				<div class="body">
					<form action="<?php base_url('direct/sekolah/edit') ?>" id="form_advanced_validation" method="post" enctype="multipart/form-data" autocomplete="on">

						<div class="row">
							<div class="col-md-6">
								<div class="form-group form-float">
									<div class="form-line">
										<input class="form-control" type="text" name="npsn" value="<?= $sekolah->npsn ?>" readonly/>
								...
								<div class="form-group form-float">
									...
									name="kode_tdc" data-live-search="true">
										...
										<?php foreach($tdc as $t) : ?>
											<option value="<?php echo $t->kode_tdc ?>" <?= $t->kode_tdc == $sekolah->kode_tdc ? "selected" : "" ?>><?php echo $t->nama_tdc ?></option>
										<?php endforeach; ?>
									</select>
								</div>
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input class="form-control" type="text" name="nama_sekolah" value="<?= $sekolah->nama_sekolah ?>" required/>
							...
							<div class="col-md-6">
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input class="form-control" type="text" name="jumlah_siswa" value="<?= $sekolah->jumlah_siswa ?>" required/>
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input class="form-control" type="text" name="longtitude" value="<?= $sekolah->longtitude ?>" required/>
								...
								<div class="form-group form-float">
									...
									name="kode_marketing" data-live-search="true">
										...
										<?php foreach($marketing as $m) : ?>
											<option value="<?php echo $m->kode_marketing ?>" <?= $m->kode_marketing == $sekolah->kode_marketing ? "selected" : "" ?>><?php echo $m->nama_marketing ?></option>
										<?php endforeach; ?>
									</select>
								</div>
							</div>
