							...
							<tbody>
								...
								<tr>
									...
									<td width='180' class="text-center" >
										<a href="<?php echo site_url('direct/event/edit/'.$s->npsn) ?>"><i class="material-icons">edit</i></a>
										<a onclick="deleteConfirm('<?php echo site_url('direct/deventdelete/'.$s->npsn) ?>')" href="#!"><i class="material-icons">delete</i></a>
										<a href="<?php echo site_url('direct/event/detail/'.$s->npsn) ?>"><i class="material-icons">description</i></a>	
									</td>
								</tr>
								<?php endforeach; ?>
