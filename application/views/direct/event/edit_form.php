							...
							<div class="col-md-6">													
								...
								<div class="form-group form-float">
									<div class="form-line" id="bs_datepicker_container">
										<input class="form-control <?php echo form_error('tgl_event') ? 'is-invalid':'' ?>" type="text" name="tgl_event" value="<?php echo date('Y-m-d',strtotime($event->tgl_event)) ?>" placeholder="Tanggal Event" required/>
									</div>
								</div>
