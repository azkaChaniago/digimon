					...
					<form action="<?php base_url('direct/marketsharesekolah/add') ?>" id="form_advanced_validation" method="post" enctype="multipart/form-data" autocomplete="on">
						...
						<div class="col-md-4">
							<div class="form-group form-float">
								<div class="form-line" id="bs_datepicker_container">
									<input class="form-control" type="text" name="tgl_marketshare" placeholder="Tanggal" required/>
							...
							<div class="form-group form-float">
								...
								name="npsn" data-live-search="true">
									...
									<?php foreach($sekolah as $t) : ?>
										<option value="<?php echo $t->npsn ?>" ><?php echo $t->nama_sekolah ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
						<div class="clearfix"></div>
							<div class="col-md-12">
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control uang" name="qty_simpati" id="simpati_ms" onkeypress="return isNumberKey(event)" required>
										<label class="form-label" for="qty_simpati">QTY Simpati*</label>
									</div>
								</div>
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control uang" name="qty_as"  onkeypress="return isNumberKey(event)" required>
										<label class="form-label" for="qty_as">QTY AS*</label>
									</div>
								</div>
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control uang" name="qty_loop"  onkeypress="return isNumberKey(event)" required>
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control uang" name="qty_mentari"  onkeypress="return isNumberKey(event)" required>
										<label class="form-label" for="qty_mentari">QTY Mentari*</label>
									</div>
								</div>
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control uang" name="qty_im3"  onkeypress="return isNumberKey(event)" required>
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control uang" name="qty_xl"  onkeypress="return isNumberKey(event)" required>
										<label class="form-label" for="qty_xl">QTY XL*</label>
									</div>
								</div>
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control uang" name="qty_axsis"  onkeypress="return isNumberKey(event)" required>
										<label class="form-label" for="qty_axsis">QTY AXSIS*</label>
									</div>
								</div>
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control uang" name="qty_tri"  onkeypress="return isNumberKey(event)" required>
										<label class="form-label" for="qty_tri">QTY Tri*</label>
									</div>
								</div>
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control uang" name="qty_smartfrend"  onkeypress="return isNumberKey(event)" required>
