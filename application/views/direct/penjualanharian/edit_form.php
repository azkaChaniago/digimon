						...
						<form action="<?php base_url('direct/penjualanharian/add') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									type="hidden" name="id_penjualan" placeholder="ID Penjualan" value="<?php echo $penjualanharian->id_penjualan ?>"/>
								...
								<div class="form-group">
									...
									type="text" name="divisi" placeholder="Divisi" value="<?php echo $penjualanharian->divisi ?>"/>
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									type="date" name="tgl_penjualan" placeholder="Tanggal Penjualan" value="<?php echo $penjualanharian->tgl_penjualan ?>"/>
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									type="text" name="lokasi_penjualan" placeholder="Lokasi Penjualan" value="<?php echo $penjualanharian->lokasi_penjualan ?>"/>
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									type="file" name="foto_kegiatan" placeholder="Foto Kegiatan" value="<?php echo $penjualanharian->foto_kegiatan ?>"/>
									<div class="invalid-feedback">
								...
								<div class="row">								
									<div class="col-sm-6">
										<div class="form-group">
											...
											type="text" name="qty_5k" placeholder="QTY 5k" value="<?php echo $penjualanharian->qty_5k ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_10k" placeholder="QTY 10k" value="<?php echo $penjualanharian->qty_10k ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_20k" placeholder="QTY 25k" value="<?php echo $penjualanharian->qty_20k ?>"/>
											<div class="invalid-feedback">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											type="text" name="qty_25k" placeholder="QTY2 5k" value="<?php echo $penjualanharian->qty_25k ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_50k" placeholder="QTY 50k" value="<?php echo $penjualanharian->qty_50k ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_100k" placeholder="QTY 100k" value="<?php echo $penjualanharian->qty_100k ?>"/>
											<div class="invalid-feedback">
								...
								<div class="row">								
									<div class="col-sm-6">
										<div class="form-group">
											...
											type="text" name="mount_bulk" placeholder="Mount Bulk" value="<?php echo $penjualanharian->mount_bulk ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="mount_legacy" placeholder="Mount Legacy" value="<?php echo $penjualanharian->mount_legacy ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="paket_max_digital" placeholder="Paket Max Digital" value="<?php echo $penjualanharian->paket_max_digital ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="no_msdn_digital" placeholder="No MSDN Digital" value="<?php echo $penjualanharian->no_msdn_digital ?>"/>
											<div class="invalid-feedback">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											type="text" name="price_digital" placeholder="Price Digital" value="<?php echo $penjualanharian->price_digital ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="msdn_tcash" placeholder="MSDN Tcash" value="<?php echo $penjualanharian->msdn_tcash ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="cashin_tcash" placeholder="Cashin Tcash" value="<?php echo $penjualanharian->cashin_tcash ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="status_tcash" placeholder="Status Tcash" value="<?php echo $penjualanharian->status_tcash ?>"/>
											<div class="invalid-feedback">
								...
								<div class="row">								
									<div class="col-sm-6">
										<div class="form-group">
											...
											type="text" name="qty_low_nsb" placeholder="QTY Low NSB" value="<?php echo $penjualanharian->qty_low_nsb ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_middle_nsb" placeholder="QTY Middle NSB" value="<?php echo $penjualanharian->qty_middle_nsb ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_high_nsb" placeholder="QTY High NSB" value="<?php echo $penjualanharian->qty_high_nsb ?>"/>
											<div class="invalid-feedback">
									...
									<div class="form-group">
											...
											type="text" name="qty_as_nsb" placeholder="QTY AS NSB" value="<?php echo $penjualanharian->qty_as_nsb ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_simpati_nsb" placeholder="QTY Simpati NSB" value="<?php echo $penjualanharian->qty_simpati_nsb ?>"/>
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_loop_nsb" placeholder="QTY Loop NSB" value="<?php echo $penjualanharian->qty_loop_nsb ?>"/>
											<div class="invalid-feedback">
