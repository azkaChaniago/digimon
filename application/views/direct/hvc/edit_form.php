						...
						<form action="<?php base_url('direct/hvc/add') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="col-md-6">
								...
								<!-- <div class="form-group">
									...
									type="hidden" name="id_hvc" placeholder="ID Penjualan" value="<?php echo $hvc->id_hvc ?>"/>
								...
								<div class="form-group">
									...
									type="date" name="tgl_hvc" placeholder="Tanggal Penjualan" value="<?php echo $hvc->tgl_hvc ?>" />
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									type="text" name="nama_mercent" placeholder="Nama Mercent" value="<?php echo $hvc->nama_mercent ?>" />
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									type="text" name="longlat_lokasi_mercent" placeholder="Longlat Lokasi Mercent" value="<?php echo $hvc->tgl_hvc ?>" />
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									type="text" name="latitude_lokasi_mercent" placeholder="Latitude Lokasi Mercent" value="<?php echo $hvc->latitude_lokasi_mercent ?>" />
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									type="text" name="alamat" placeholder="Alamat" value="<?php echo $hvc->alamat ?>" />
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									<input type="hidden" value="<?php echo $hvc->foto_kegiatan ?>" name="old_image" />
									<div class="invalid-feedback">
								...
								<div class="form-group">
									...
									type="text" name="keterangan_kegiatan" placeholder="Keterangan Kegiatan" value="<?php echo $hvc->keterangan_kegiatan ?>" />
									<div class="invalid-feedback">
								...
								<div class="row">								
									<div class="col-sm-6">
										<div class="form-group">
											...
											type="text" name="qty_5k" placeholder="QTY 5k" value="<?php echo $hvc->qty_5k ?>" />
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_10k" placeholder="QTY 10k" value="<?php echo $hvc->qty_10k ?>" />
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_20k" placeholder="QTY 25k" value="<?php echo $hvc->qty_20k ?>" />
											<div class="invalid-feedback">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											type="text" name="qty_25k" placeholder="QTY2 5k" value="<?php echo $hvc->qty_25k ?>" />
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_50k" placeholder="QTY 50k" value="<?php echo $hvc->qty_50k ?>" />
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_100k" placeholder="QTY 100k" value="<?php echo $hvc->qty_100k ?>" />
											<div class="invalid-feedback">
								...
								<div class="row">								
									<div class="col-sm-12">
										<div class="form-group">
											...
											type="text" name="mount_bulk" placeholder="Mount Bulk" value="<?php echo $hvc->mount_bulk ?>" />
											<div class="invalid-feedback">
								...
								<div class="row">								
									<div class="col-sm-6">
										<div class="form-group">
											...
											type="text" name="qty_low_nsb" placeholder="QTY Low NSB" value="<?php echo $hvc->qty_low_nsb ?>" />
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_middle_nsb" placeholder="QTY Middle NSB" value="<?php echo $hvc->qty_middle_nsb ?>" />
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_high_nsb" placeholder="QTY High NSB" value="<?php echo $hvc->qty_high_nsb ?>" />
											<div class="invalid-feedback">
									...
									<div class="form-group">
											...
											type="text" name="qty_as_nsb" placeholder="QTY AS NSB" value="<?php echo $hvc->qty_as_nsb ?>" />
											<div class="invalid-feedback">
										...
										<!-- <div class="form-group">
											...
											type="text" name="qty_simpati_nsb" placeholder="QTY Simpati NSB" value="<?php echo $hvc->qty_simpati_nsb ?>" />
											<div class="invalid-feedback">
										...
										<div class="form-group">
											...
											type="text" name="qty_loop_nsb" placeholder="QTY Loop NSB" value="<?php echo $hvc->qty_loop_nsb ?>" />
											<div class="invalid-feedback">
