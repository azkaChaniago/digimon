			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<h2>Marketing</h2><hr>
						<a href="<?php echo site_url('direct/marketing/add') ?>"><i class="fas fa-plus"></i> Add New</a>
					</div>
					<div class="card-body">
							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td width="250">
											<a href="<?php echo site_url('direct/marketing/edit/'.$mar->kode_marketing) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
											<a onclick="deleteConfirm('<?php echo site_url('direct/marketing/remove/'.$mar->kode_marketing) ?>')"
											 href="#!" class="btn btn-small text-danger"><i class="fas fa-trash"></i> Remove</a>
											<a href="<?php echo site_url('direct/marketing/detail/'.$mar->kode_marketing) ?>" 
