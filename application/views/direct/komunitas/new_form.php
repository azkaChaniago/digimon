							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										type="text" name="id_komunitas" placeholder="ID Komunitas" />
									...
									<div class="form-group">
										...
										type="text" name="nama_komunitas" placeholder="Nama Komunitas" />
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										type="text" name="nama_ketua" placeholder="Nama Ketua" />
										<div class="invalid-feedback">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										type="text" name="no_hpketua" placeholder="No HP Ketua" />
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										type="text" name="jumlah_anggota" placeholder="Jumlah Anggota" />
										<div class="invalid-feedback">
									...
									<div class="form-group">
										...
										type="text" name="nama_sosmed" placeholder="Nama Sosmed" />
										<div class="invalid-feedback">
