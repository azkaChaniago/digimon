							...
							<tbody>
								...
								<tr>
									...
									<td width='180' class="text-center" >
										<a href="<?php echo site_url('direct/event/edit/'.$k->id_komunitas) ?>"><i class="material-icons">edit</i></a>
										<a onclick="deleteConfirm('<?php echo site_url('direct/deventdelete/'.$k->id_komunitas) ?>')" href="#!"><i class="material-icons">delete</i></a>
										<a href="<?php echo site_url('direct/event/detail/'.$k->id_komunitas) ?>"><i class="material-icons">description</i></a>	
									</td>
								</tr>
								<?php endforeach; ?>
