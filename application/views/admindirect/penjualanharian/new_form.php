	...
	<section class="content">
		<div class="container-fluid">
			...
			<div class="card">
				...
				<div class="body">
					<form action="<?php base_url('direct/penjualanharian/add') ?>" id="form_advanced_validation" method="post" enctype="multipart/form-data" autocomplete="on">
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input class="form-control <?php echo form_error('paket_max_digital') ? 'is-invalid':'' ?>"
											type="text" name="paket_max_digital" onkeypress="return isNumberKey(event)" required/>
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input class="form-control <?php echo form_error('no_msdn_digital') ? 'is-invalid':'' ?>"
											type="text" name="no_msdn_digital" onkeypress="return isNumberKey(event)" required/>
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input class="form-control <?php echo form_error('price_digital') ? 'is-invalid':'' ?>"
											type="text" name="price_digital" onkeypress="return isNumberKey(event)" required/>
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input class="form-control <?php echo form_error('msdn_tcash') ? 'is-invalid':'' ?>"
											type="text" name="msdn_tcash" onkeypress="return isNumberKey(event)" required/>
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input class="form-control <?php echo form_error('cashin_tcash') ? 'is-invalid':'' ?>"
											type="text" name="cashin_tcash" onkeypress="return isNumberKey(event)" required/>
								...
								<div class="form-group form-float">
									<div class="form-line">
										<input class="form-control <?php echo form_error('status_tcash') ? 'is-invalid':'' ?>"
											type="text" name="status_tcash" onkeypress="return isNumberKey(event)" required/>
