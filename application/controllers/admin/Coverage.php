...
class Coverage extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/coverage/list', $data);
    }
    ...
    public function add()
    {
        ...
        $this->load->view('admin/coverage/new_form');
    }

    public function edit($id)
    {
        is_logged_in();
        if (!isset($id)) redirect('admin/coverage');
        ...
        $this->load->view('admin/coverage/edit_form', $data);
    }
    ...
    public function remove($id)
    {
        ...
        {
            redirect(site_url('admin/coverage'));
        }
    }

    public function detail($id=null)
    {
        $this->load->view('admin/coverage/detail');
    }
