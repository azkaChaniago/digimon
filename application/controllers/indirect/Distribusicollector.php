...
class Distribusicollector extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data += [
            'collector' => $this->distribusicollector_model->getAll($data['tdc']),
        ];
        $this->load->view('indirect/distribusi/list_collector', $data);
    }
    ...
    public function add()
    {
        ...
        if ($validation->run())
        {
            ...
            redirect(site_url('indirect/distribusicollector'));
        }
        ...
        $this->load->view('indirect/distribusi/new_form_collector', $data);
    }

    public function edit($id=null)
    {
        is_logged_in();
        if (!isset($id)) redirect('indirect/distribusicollector');
        ...
        $this->load->view('indirect/distribusi/edit_form_collector', $data);
    }
    ...
    public function detail($id=null)
    {
        ...
        $this->load->view('indirect/distribusi/detail_collector', $data);
    }
    ...
    public function exportpdf($start, $end)
    {
        ...
        $this->load->view('indirect/distribusi/pdf_export_collector', $data);
    }
