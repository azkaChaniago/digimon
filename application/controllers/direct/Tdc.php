...
class TDC extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/direct/tdc/list', $data);
    }
    ...
    public function add()
    {
        ...
        $this->load->view('admin/direct/tdc/new_form', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('admin/direct/tdc/edit_form', $data);
    }
    ...
    public function detail($id=null)
    {
        ...
        $this->load->view('admin/direct/tdc/detail', $data);
    }
