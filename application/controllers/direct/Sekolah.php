...
class Sekolah extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/direct/sekolah/list', $data);
    }
    ...
    public function add()
    {
        ...
        $this->load->view('admin/direct/sekolah/new_form', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('admin/direct/sekolah/edit_form', $data);
    }
    ...
    public function detail($id=null)
    {
        ...
        $this->load->view('admin/direct/sekolah/detail', $data);
    }
