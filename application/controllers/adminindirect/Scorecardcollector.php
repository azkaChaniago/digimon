...
class Scorecardcollector extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data += [
            'collector' => $this->scorecardcollector_model->displayTargetAssignment(),
        ];
    ...
    public function add()
    {
        ...
        if ($validation->run())
        {
            ...
            redirect(site_url('adminindirect/scorecardcollector'));
        }
        ...
        $this->load->view('adminindirect/scorecard/new_form_collector', $data);
    }

    public function edit($id=null)
    {
        is_logged_in();
        if (!isset($id)) redirect('adminindirect/scorecardcollector');
        ...
        $this->load->view('adminindirect/scorecard/edit_form_collector', $data);
    }
