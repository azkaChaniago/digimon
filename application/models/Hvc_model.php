...
class Hvc_model extends CI_Model
{
    ...
    {
        return [
            ['field' => 'id_hvc', 'label' => 'ID HVC','rules' => 'required'],
            ...
            ['field' => 'keterangan_kegiatan', 'label' => 'Keterangan Kegiatan','rules' => 'required'],
    ...
    public function save()
    {
        ...
        $data = array(
            'id_hvc' => $this->id_hvc = $post['id_hvc'],
            'kode_tdc' => $this->kode_tdc = $post['kode_tdc'],
            'tgl_hvc' => $this->tgl_hvc = $post['tgl_hvc'],
            ...
            'foto_kegiatan' => $this->foto_kegiatan = $this_>uploadImage(),
            'keterangan_kegiatan' => $this->keterangan_kegiatan = $post['keterangan_kegiatan'],
